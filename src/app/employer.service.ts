...
export class EmployerService {
  ...
  getEmployerAccount(id: number): Observable<any> {
  ...
  editCompanyProfile(id: number, company: Company): Observable<any> {
  ...
  editEmployerAccount(id: number, employer: any): Observable<any> {
